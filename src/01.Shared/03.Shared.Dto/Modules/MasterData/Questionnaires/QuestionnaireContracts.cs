...
public sealed record QuestionnaireListItem(Guid Id, Guid VersionId, string Code, string BusinessProcess, VendorCompanyStatusType? VendorType, string Section, int Version, QuestionnaireVersionStatus Status, bool IsActive);
...
public sealed record QuestionnaireSectionItem(Guid Id, string Code, string Title, int Order, VendorCompanyStatusType? CompanyType, IReadOnlyList<QuestionnaireQuestionItem> Questions);
public sealed record QuestionnaireQuestionItem(Guid Id, string Code, string Label, string? Hint, string? Placeholder, QuestionnaireQuestionType Type, int Order, bool IsRequired, bool IsVisible, IReadOnlyList<QuestionnaireOptionItem> Options);
...
public record AddQuestionnaireRequest { public required string Code { get; init; } public required string BusinessProcess { get; init; } }
...
public static class QuestionnaireRoutes
{
    ...
    public const string DeleteDraft = RouteConfig.BasePath + "/{id:guid}/draft";
}
