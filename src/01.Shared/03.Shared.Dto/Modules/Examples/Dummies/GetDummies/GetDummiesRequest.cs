...
public record GetDummiesRequest
{
...
public sealed class GetDummiesRequestValidator : AbstractValidatorBase<GetDummiesRequest>
{
    public GetDummiesRequestValidator()
    {
