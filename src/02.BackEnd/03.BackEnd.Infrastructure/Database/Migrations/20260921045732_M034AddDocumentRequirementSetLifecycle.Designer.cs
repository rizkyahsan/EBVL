...
namespace EBVL.BackEnd.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260921045732_M034AddDocumentRequirementSetLifecycle")]
    partial class M034AddDocumentRequirementSetLifecycle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EBVL.BackEnd.Domain.Entities.DocumentDefinition", b =>
                {
                    ...
                    b.Property<Guid>("DocumentRequirementSetId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DocumentRequirementSetId", "Code")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");

                    b.HasIndex("DocumentRequirementSetId", "Name")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");

                    b.ToTable("DocumentDefinitions", "EBVL");
                });

            modelBuilder.Entity("EBVL.BackEnd.Domain.Entities.DocumentRequirementSet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("DocumentRequirementSetSeriesId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DocumentRequirementSetSeriesId", "Version")
                        .IsUnique();

                    b.HasIndex(new[] { "DocumentRequirementSetSeriesId" }, "IX_DocumentRequirementSets_OneDraftPerSeries")
                        .IsUnique()
                        .HasFilter("[Status] = 'Draft' AND [IsDeleted] = 0");

                    b.HasIndex(new[] { "DocumentRequirementSetSeriesId" }, "IX_DocumentRequirementSets_OnePublishPerSeries")
                        .IsUnique()
                        .HasFilter("[Status] = 'Publish' AND [IsDeleted] = 0");

                    b.HasIndex(new[] { "BusinessProcess" }, "IX_DocumentRequirementSets_OneSeriesPerProcess")
                        .IsUnique()
                        .HasFilter("[Version] = 1 AND [IsDeleted] = 0");

                    b.ToTable("DocumentRequirementSets", "EBVL");
                });
            ...
            modelBuilder.Entity("EBVL.BackEnd.Domain.Entities.Questionnaire", b =>
                {
                    ...
                    b.Property<Guid>("QuestionnaireSeriesId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EBVL.BackEnd.Domain.Entities.VendorRegistration", b =>
                {
                    ...
                    b.HasIndex("DocumentRequirementSetId");
            ...
            modelBuilder.Entity("EBVL.BackEnd.Domain.Entities.DocumentDefinition", b =>
                {
                    ...
                    b.Navigation("DocumentRequirementSet");
                });

            modelBuilder.Entity("EBVL.BackEnd.Domain.Entities.DocumentRequirementSet", b =>
                {
                    b.HasOne("EBVL.BackEnd.Domain.Entities.DocumentRequirementSet", "PreviousVersion")
                        .WithMany()
            ...
            modelBuilder.Entity("EBVL.BackEnd.Domain.Entities.Questionnaire", b =>
                {
                    b.HasOne("EBVL.BackEnd.Domain.Entities.Questionnaire", "PreviousVersion")
                        .WithMany()
                        .HasForeignKey("PreviousVersionId")
                        .OnDelete(DeleteBehavior.Restrict);
