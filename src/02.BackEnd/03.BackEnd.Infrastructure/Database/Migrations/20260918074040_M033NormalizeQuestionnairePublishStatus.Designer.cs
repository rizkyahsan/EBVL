...
namespace EBVL.BackEnd.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260918074040_M033NormalizeQuestionnairePublishStatus")]
    partial class M033NormalizeQuestionnairePublishStatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EBVL.BackEnd.Domain.Entities.DocumentDefinition", b =>
                {
                    ...
                    b.HasIndex("BusinessProcess", "Code")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");

                    b.HasIndex("BusinessProcess", "Name")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");
